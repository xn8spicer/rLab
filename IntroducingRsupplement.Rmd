...
search()
```
RStudio encourages the use of fully-qualified names with the 'code completion' feature using the 'tab' key.   From the LR console or an UR R script editing window, **practice using this feature**.  Code completion works with names of objects as well as commands.  Try typing a few characters in the command line and hit tab, see what is displayed.
